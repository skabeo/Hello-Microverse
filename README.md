...
Feel free to check the [issues page]https://github.com/skabeo/Hello-Microverse/issues).
...
This project is [MIT](https://github.com/skabeo/Hello-Microverse/blob/main/LICENSE.md) licensed.
